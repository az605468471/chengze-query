      ...
      output: {
        manualChunks: {
          ...
          'components': [
            ...
            './src/components/HolderDistribution.jsx',
            './src/components/LiquidityInfo.jsx',
            './src/components/TransactionHistory.jsx',
            './src/components/PriceHistory.jsx',
            './src/components/ContractSecurity.jsx',
            './src/components/Tokenomics.jsx',
            './src/components/LiquiditySafety.jsx',
            './src/components/Governance.jsx',
            './src/components/TeamBackground.jsx',
            './src/components/OnchainAnalysis.jsx',
